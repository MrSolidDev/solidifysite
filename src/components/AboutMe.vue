...
const events = ref([
  ...
  {
    status: 'Mavi de Occidente SA de CV',
    date: '2025-Actualidad · Desarrollador Full Stack',
    icon: 'pi pi-code',
    color: '#7e3ff2', // plata/gris claro
    html: `
      <p class="text-surface-300 leading-relaxed">
        Diseñé <strong>soluciones tecnológicas</strong> a la medida y lideré procesos de 
        <em>preventa</em>, documentación y <em>demos</em> para clientes empresariales.
...
<template>
    <div class="flex flex-col w-full justify-center items-center gap-5">
        <div class="flex flex-col w-full items-center text-center gap-2 sm:gap-3 py-6">
        ...
        <div class="flex flex-col w-full items-center gap-2">
            <div class="max-w-3xl text-lg space-y-3" v-html="descripcion_html"></div>
        </div>
        <div class="card">
           <Timeline :value="events" align="alternate" class="customized-timeline">
                ...
                <template #content="slotProps">
                    <Card class="mt-4 bg-[#161E21] text-surface-100 border border-white/5 rounded-2xl overflow-hidden">
                        <template #title>
